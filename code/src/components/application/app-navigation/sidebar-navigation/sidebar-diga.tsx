...
import { NavProjectCard } from "../base-components/nav-project-card";
    ...
    const content = (
        ...
        >
            <div className="flex flex-col gap-5 px-4 lg:px-5">
                <img src="/secondary-logo.svg" alt="Diga Logo" className="h-25" />
                <hr className="h-px w-full border-none bg-border-secondary" />
            </div>

            {showAccountCard && <NavProjectCard />}
